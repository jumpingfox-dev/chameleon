...
// 0. DEFAULT THEME
// =============================================================================
final ({FColors light, FColors dark}) defaultTheme = (
  light: FColors(
    brightness: .light,
...
// =============================================================================
final ({FColors light, FColors dark}) redTheme = (
  light: FColors(
    brightness: .light,
    systemOverlayStyle: .dark,
...
// =============================================================================
final ({FColors light, FColors dark}) orangeTheme = (
  light: FColors(
    brightness: .light,
    systemOverlayStyle: .dark,
    barrier: _hsl(0, 0.0, 0.0, 0.2),
...
// =============================================================================
final ({FColors light, FColors dark}) yellowTheme = (
  light: FColors(
    brightness: .light,
    systemOverlayStyle: .dark,
    barrier: _hsl(0, 0.0, 0.0, 0.2),
...
// =============================================================================
final ({FColors light, FColors dark}) greenTheme = (
  light: FColors(
    brightness: .light,
    systemOverlayStyle: .dark,
    barrier: _hsl(0, 0.0, 0.0, 0.2),
...
// =============================================================================
final ({FColors light, FColors dark}) blueTheme = (
  light: FColors(
    brightness: .light,
    systemOverlayStyle: .dark,
    barrier: _hsl(0, 0.0, 0.0, 0.2),
...
// =============================================================================
final ({FColors light, FColors dark}) indigoTheme = (
  light: FColors(
    brightness: .light,
    systemOverlayStyle: .dark,
    barrier: _hsl(0, 0.0, 0.0, 0.2),
...
// =============================================================================
final ({FColors light, FColors dark}) violetTheme = (
  light: FColors(
    brightness: .light,
    systemOverlayStyle: .dark,
    barrier: _hsl(0, 0.0, 0.0, 0.2),
...
// =============================================================================
final ({FColors light, FColors dark}) prismTheme = (
  light: FColors(
    brightness: .light,
    systemOverlayStyle: .dark,
